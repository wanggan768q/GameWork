...
class GameCacheData : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_isaccepttrophynotification() const;
  inline void clear_isaccepttrophynotification();
  static const int kIsAcceptTrophyNotificationFieldNumber = 13;
  inline bool isaccepttrophynotification() const;
  inline void set_isaccepttrophynotification(bool value);

  // optional .message.LanUserInfoData lanCacheData = 14;
  inline bool has_lancachedata() const;
  inline void clear_lancachedata();
  static const int kLanCacheDataFieldNumber = 14;
  inline const ::message::LanUserInfoData& lancachedata() const;
  inline ::message::LanUserInfoData* mutable_lancachedata();
  inline ::message::LanUserInfoData* release_lancachedata();
  inline void set_allocated_lancachedata(::message::LanUserInfoData* lancachedata);
 ...
 private:
  ...
  inline void set_has_isaccepttrophynotification();
  inline void clear_has_isaccepttrophynotification();
  inline void set_has_lancachedata();
  inline void clear_has_lancachedata();
  ...
  bool isaccepttrophynotification_;
  ::std::string* nickname_;
  ::std::string* weibo_name_;
  ::std::string* weibo_id_;
  ::message::LanUserInfoData* lancachedata_;
...
// optional bool isAcceptTrophyNotification = 13 [default = true];
inline bool GameCacheData::has_isaccepttrophynotification() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void GameCacheData::set_has_isaccepttrophynotification() {
  _has_bits_[0] |= 0x00001000u;
}
inline void GameCacheData::clear_has_isaccepttrophynotification() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void GameCacheData::clear_isaccepttrophynotification() {
  isaccepttrophynotification_ = true;
  clear_has_isaccepttrophynotification();
}
inline bool GameCacheData::isaccepttrophynotification() const {
  return isaccepttrophynotification_;
}
inline void GameCacheData::set_isaccepttrophynotification(bool value) {
  set_has_isaccepttrophynotification();
  isaccepttrophynotification_ = value;
}

// optional .message.LanUserInfoData lanCacheData = 14;
inline bool GameCacheData::has_lancachedata() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void GameCacheData::set_has_lancachedata() {
  _has_bits_[0] |= 0x00002000u;
}
inline void GameCacheData::clear_has_lancachedata() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void GameCacheData::clear_lancachedata() {
  if (lancachedata_ != NULL) lancachedata_->::message::LanUserInfoData::Clear();
  clear_has_lancachedata();
}
inline const ::message::LanUserInfoData& GameCacheData::lancachedata() const {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return lancachedata_ != NULL ? *lancachedata_ : *default_instance().lancachedata_;
#else
  return lancachedata_ != NULL ? *lancachedata_ : *default_instance_->lancachedata_;
#endif
}
inline ::message::LanUserInfoData* GameCacheData::mutable_lancachedata() {
  set_has_lancachedata();
  if (lancachedata_ == NULL) lancachedata_ = new ::message::LanUserInfoData;
  return lancachedata_;
}
inline ::message::LanUserInfoData* GameCacheData::release_lancachedata() {
  clear_has_lancachedata();
  ::message::LanUserInfoData* temp = lancachedata_;
  lancachedata_ = NULL;
  return temp;
}
inline void GameCacheData::set_allocated_lancachedata(::message::LanUserInfoData* lancachedata) {
  delete lancachedata_;
  lancachedata_ = lancachedata;
  if (lancachedata) {
    set_has_lancachedata();
  } else {
    clear_has_lancachedata();
