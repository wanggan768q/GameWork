...
const int UpdateUserInfo::kLostCountFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_lostCount;
        break;
      }
...
void UpdateUserInfo::SerializeWithCachedSizes(
  ...
  // optional uint32 lostCount = 8;
  if (has_lostcount()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(8, this->lostcount(), output);
  }
