...
class UpdateUserInfo : public ::google::protobuf::MessageLite {
 public:
  ...
  // optional uint32 lostCount = 8;
  inline bool has_lostcount() const;
  inline void clear_lostcount();
  static const int kLostCountFieldNumber = 8;
  inline ::google::protobuf::uint32 lostcount() const;
  inline void set_lostcount(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::uint32 lostcount_;
...
// optional uint32 lostCount = 8;
inline bool UpdateUserInfo::has_lostcount() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void UpdateUserInfo::set_has_lostcount() {
  _has_bits_[0] |= 0x00000080u;
}
inline void UpdateUserInfo::clear_has_lostcount() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void UpdateUserInfo::clear_lostcount() {
  lostcount_ = 0u;
  clear_has_lostcount();
}
inline ::google::protobuf::uint32 UpdateUserInfo::lostcount() const {
  return lostcount_;
}
inline void UpdateUserInfo::set_lostcount(::google::protobuf::uint32 value) {
  set_has_lostcount();
  lostcount_ = value;
}
