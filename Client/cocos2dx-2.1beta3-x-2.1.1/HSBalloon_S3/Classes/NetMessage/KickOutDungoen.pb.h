...
enum NotifyKickedOutDungoen_KickedOutCause {
  ...
  NotifyKickedOutDungoen_KickedOutCause_Strength_Not_Enough = 3
};
...
const NotifyKickedOutDungoen_KickedOutCause NotifyKickedOutDungoen_KickedOutCause_KickedOutCause_MAX = NotifyKickedOutDungoen_KickedOutCause_Strength_Not_Enough;
...
class NotifyKickedOutDungoen : public ::google::protobuf::MessageLite {
 public:
  ...
  static const KickedOutCause Strength_Not_Enough = NotifyKickedOutDungoen_KickedOutCause_Strength_Not_Enough;
