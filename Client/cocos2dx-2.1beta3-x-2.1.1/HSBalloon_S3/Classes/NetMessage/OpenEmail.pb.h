...
class OpenEmailResponse : public ::google::protobuf::MessageLite {
 public:
  ...
  static const int kConstitutionFieldNumber = 2;
  inline ::google::protobuf::int32 constitution() const;
  inline void set_constitution(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::int32 constitution_;
  int state_;
...
// optional int32 constitution = 2;
inline bool OpenEmailResponse::has_constitution() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void OpenEmailResponse::set_has_constitution() {
  _has_bits_[0] |= 0x00000002u;
}
inline void OpenEmailResponse::clear_has_constitution() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void OpenEmailResponse::clear_constitution() {
  constitution_ = 0;
  clear_has_constitution();
}
inline ::google::protobuf::int32 OpenEmailResponse::constitution() const {
  return constitution_;
}
inline void OpenEmailResponse::set_constitution(::google::protobuf::int32 value) {
