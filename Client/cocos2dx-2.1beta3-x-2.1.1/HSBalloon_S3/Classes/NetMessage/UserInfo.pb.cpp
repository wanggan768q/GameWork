...
void protobuf_ShutdownFile_UserInfo_2eproto() {
  ...
  delete UserBasicInfo_UnlockFigure::default_instance_;
}
...
void protobuf_AddDesc_UserInfo_2eproto() {
  ...
  UserBasicInfo_UnlockFigure::default_instance_ = new UserBasicInfo_UnlockFigure();
  UserBasicInfo::default_instance_->InitAsDefaultInstance();
  UserBasicInfo_EffectData::default_instance_->InitAsDefaultInstance();
  UserBasicInfo_UnlockFigure::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int UserBasicInfo_UnlockFigure::kIdFieldNumber;
const int UserBasicInfo_UnlockFigure::kLevelFieldNumber;
#endif  // !_MSC_VER

UserBasicInfo_UnlockFigure::UserBasicInfo_UnlockFigure()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
}

void UserBasicInfo_UnlockFigure::InitAsDefaultInstance() {
}

UserBasicInfo_UnlockFigure::UserBasicInfo_UnlockFigure(const UserBasicInfo_UnlockFigure& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
}

void UserBasicInfo_UnlockFigure::SharedCtor() {
  _cached_size_ = 0;
  id_ = 0u;
  level_ = 0u;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
void UserBasicInfo_UnlockFigure::SharedDtor() {
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  if (this != &default_instance()) {
  #else
  if (this != default_instance_) {
...
void UserBasicInfo_UnlockFigure::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const UserBasicInfo_UnlockFigure& UserBasicInfo_UnlockFigure::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_UserInfo_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_UserInfo_2eproto();
...
UserBasicInfo_UnlockFigure* UserBasicInfo_UnlockFigure::default_instance_ = NULL;

UserBasicInfo_UnlockFigure* UserBasicInfo_UnlockFigure::New() const {
  return new UserBasicInfo_UnlockFigure;
}

void UserBasicInfo_UnlockFigure::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    id_ = 0u;
    level_ = 0u;
  }
...
bool UserBasicInfo_UnlockFigure::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
...
void UserBasicInfo_UnlockFigure::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // required uint32 id = 1;
  if (has_id()) {
...
int UserBasicInfo_UnlockFigure::ByteSize() const {
  int total_size = 0;
...
void UserBasicInfo_UnlockFigure::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const UserBasicInfo_UnlockFigure*>(&from));
}

void UserBasicInfo_UnlockFigure::MergeFrom(const UserBasicInfo_UnlockFigure& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_id()) {
      set_id(from.id());
...
void UserBasicInfo_UnlockFigure::CopyFrom(const UserBasicInfo_UnlockFigure& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool UserBasicInfo_UnlockFigure::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;

  return true;
}

void UserBasicInfo_UnlockFigure::Swap(UserBasicInfo_UnlockFigure* other) {
  if (other != this) {
...
::std::string UserBasicInfo_UnlockFigure::GetTypeName() const {
  return "message.UserBasicInfo.UnlockFigure";
}
...
const int UserBasicInfo::kFigureIdFieldNumber;
const int UserBasicInfo::kFigureLevelFieldNumber;
const int UserBasicInfo::kFiguresFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 27: {
        ...
        if (input->ExpectTag(224)) goto parse_figureId;
        break;
      }
      ...
      case 28: {
        ...
        if (input->ExpectTag(232)) goto parse_figureLevel;
        break;
      }
      ...
      case 29: {
        ...
        if (input->ExpectTag(242)) goto parse_figures;
        break;
      }
...
void UserBasicInfo::SerializeWithCachedSizes(
  ...
  // optional uint32 figureId = 28 [default = 7000];
  if (has_figureid()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(28, this->figureid(), output);
  }

  // optional uint32 figureLevel = 29 [default = 1];
  if (has_figurelevel()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(29, this->figurelevel(), output);
  }

  // repeated .message.UserBasicInfo.UnlockFigure figures = 30;
  for (int i = 0; i < this->figures_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessage(
      30, this->figures(i), output);
  }
...
int UserBasicInfo::ByteSize() const {
  ...
  // repeated .message.UserBasicInfo.UnlockFigure figures = 30;
  total_size += 2 * this->figures_size();
  for (int i = 0; i < this->figures_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->figures(i));
...
void UserBasicInfo::MergeFrom(const UserBasicInfo& from) {
  ...
  figures_.MergeFrom(from.figures_);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_uid()) {
      set_uid(from.uid());
    }
  ...
  if (from._has_bits_[24 / 32] & (0xffu << (24 % 32))) {
    ...
    if (from.has_figurelevel()) {
      set_figurelevel(from.figurelevel());
    }
  }
}
...
bool UserBasicInfo::IsInitialized() const {
  ...
  for (int i = 0; i < figures_size(); i++) {
    if (!this->figures(i).IsInitialized()) return false;
  }
  return true;
}
...
void UserBasicInfo::Swap(UserBasicInfo* other) {
  if (other != this) {
    ...
    std::swap(figurelevel_, other->figurelevel_);
