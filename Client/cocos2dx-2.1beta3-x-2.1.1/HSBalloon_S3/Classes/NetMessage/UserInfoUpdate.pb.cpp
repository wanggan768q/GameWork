...
const UserInfoUpdateRequest_UpdateType UserInfoUpdateRequest::User_Figure;
...
const int UserInfoUpdateRequest::kFigureIdFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_figureId;
        break;
      }
...
void UserInfoUpdateRequest::SerializeWithCachedSizes(
  ...
  // optional uint32 figureId = 4;
  if (has_figureid()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(4, this->figureid(), output);
  }
...
const UserInfoUpdateResponse_UpdateState UserInfoUpdateResponse::NO_FIGURE;
