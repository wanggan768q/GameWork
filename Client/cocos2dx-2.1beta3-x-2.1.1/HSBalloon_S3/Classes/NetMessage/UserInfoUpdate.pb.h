...
enum UserInfoUpdateRequest_UpdateType {
  ...
  UserInfoUpdateRequest_UpdateType_User_Figure = 3
};
...
const UserInfoUpdateRequest_UpdateType UserInfoUpdateRequest_UpdateType_UpdateType_MAX = UserInfoUpdateRequest_UpdateType_User_Figure;
...
enum UserInfoUpdateResponse_UpdateState {
  ...
  UserInfoUpdateResponse_UpdateState_NOMONEY = 3,
  UserInfoUpdateResponse_UpdateState_NO_FIGURE = 4
};
...
const UserInfoUpdateResponse_UpdateState UserInfoUpdateResponse_UpdateState_UpdateState_MAX = UserInfoUpdateResponse_UpdateState_NO_FIGURE;
...
class UserInfoUpdateRequest : public ::google::protobuf::MessageLite {
 public:
  ...
  static const UpdateType User_Figure = UserInfoUpdateRequest_UpdateType_User_Figure;
  ...
  // optional uint32 figureId = 4;
  inline bool has_figureid() const;
  inline void clear_figureid();
  static const int kFigureIdFieldNumber = 4;
...
class UserInfoUpdateResponse : public ::google::protobuf::MessageLite {
 public:
  ...
  static const UpdateState NOMONEY = UserInfoUpdateResponse_UpdateState_NOMONEY;
  static const UpdateState NO_FIGURE = UserInfoUpdateResponse_UpdateState_NO_FIGURE;
...
// optional uint32 figureId = 4;
inline bool UserInfoUpdateRequest::has_figureid() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void UserInfoUpdateRequest::set_has_figureid() {
  _has_bits_[0] |= 0x00000008u;
}
inline void UserInfoUpdateRequest::clear_has_figureid() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void UserInfoUpdateRequest::clear_figureid() {
  figureid_ = 0u;
  clear_has_figureid();
}
inline ::google::protobuf::uint32 UserInfoUpdateRequest::figureid() const {
  return figureid_;
}
inline void UserInfoUpdateRequest::set_figureid(::google::protobuf::uint32 value) {
  set_has_figureid();
  figureid_ = value;
}
