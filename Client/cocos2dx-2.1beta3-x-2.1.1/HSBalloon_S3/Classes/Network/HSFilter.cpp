...
bool HSFilter::SendDistribution( int commandID , const std::string& data,const std::string &describe)
{
    ...
    if (HS_IsLanMode())
    {
        //HSJava::ShaderJava()->autoDistribute(data.c_str(),data.length());
...
::google::protobuf::Message* HSFilter::CreaterMessage(int ID)
{
	switch(ID)
	{
        ...
        case API_GameBuyFigureResponse:
            ...
            return HS_CREATER_GOOGLE_MESSAGE(GameBuyFigureResponse);
            
        case API_GameUpgradeFigureLevelResponse:
            
            return HS_CREATER_GOOGLE_MESSAGE(GameUpgradeFigureLevelResponse);
            
        case API_GameSearchStrengthResponse:
            
            return HS_CREATER_GOOGLE_MESSAGE(GameSearchStrengthResponse);
            
        case API_MatchBuyFigureResponse:
            
            return HS_CREATER_GOOGLE_MESSAGE(MatchBuyFigureResponse);
            
        case API_MatchUpgradeFigureLevelResponse:
            
            return HS_CREATER_GOOGLE_MESSAGE(MatchUpgradeFigureLevelResponse);
            
        case API_ChangeFigureResponse:
            
            return HS_CREATER_GOOGLE_MESSAGE(ChangeFigureResponse);
            
        case API_NotifyUserUpdateResponse:
            
            return HS_CREATER_GOOGLE_MESSAGE(NotifyUserUpdateResponse);
            
        case API_ValidateStrengthResponse:
            
            return HS_CREATER_GOOGLE_MESSAGE(ValidateStrengthResponse);
            
        case API_MatchSearchStrengthResponse:
            
            return HS_CREATER_GOOGLE_MESSAGE(MatchSearchStrengthResponse);
...
#define HS_REGISTER_PROTOCOL(__Request__,__Response__,__Name__) this->RegisterMessage(__Request__,__Response__,__Name__)
    ...
    HS_REGISTER_PROTOCOL(API_GameBuyFigureRequest,API_GameBuyFigureResponse,"GameBuyFigure");
    HS_REGISTER_PROTOCOL(API_GameUpgradeFigureLevelRequest,API_GameUpgradeFigureLevelResponse,"GameUpgradeFigureLevel");
    HS_REGISTER_PROTOCOL(API_GameSearchStrengthRequest,API_GameSearchStrengthResponse,"GameSearchStrength");
    HS_REGISTER_PROTOCOL(API_ValidateStrengthRequest,API_ValidateStrengthResponse,"ValidateStrength");
    ...
    HS_REGISTER_PROTOCOL(API_MatchBuyFigureRequest,API_MatchBuyFigureResponse,"MatchBuyFigure");
    HS_REGISTER_PROTOCOL(API_MatchUpgradeFigureLevelRequest,API_MatchUpgradeFigureLevelResponse,"MatchUpgradeFigureLevel");
    HS_REGISTER_PROTOCOL(API_NotifyUserUpdateRequest,API_NotifyUserUpdateResponse,"NotifyUserUpdate");
    HS_REGISTER_PROTOCOL(API_ChangeFigureRequest,API_ChangeFigureResponse,"ChangeFigure");
    HS_REGISTER_PROTOCOL(API_MatchSearchStrengthRequest,API_MatchSearchStrengthResponse,"MatchSearchStrength");
    
    
    
    //////////////////////////////////////////////////////////////////////////
    // Lan
    //HS_REGISTER_PROTOCOL(API_LanSyncUserInfoReRequest,API_LanSyncUserInfoResponse,"LanSyncUserInfo");
