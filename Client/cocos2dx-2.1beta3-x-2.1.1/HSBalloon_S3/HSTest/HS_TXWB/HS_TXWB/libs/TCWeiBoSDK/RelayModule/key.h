...
#define KLanguageCancel        @"Cancel"
#define KLanguageAuth          @"Auth"
#define kLanguageRebroadcast   @"Rebroadcast"
#define kLanguageSend          @"Send"

#define kLanguageBack             @"Back"
#define kLanguageFriends          @"Friends"
