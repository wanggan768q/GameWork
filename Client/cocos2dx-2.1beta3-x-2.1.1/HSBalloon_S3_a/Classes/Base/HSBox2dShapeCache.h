...
#define HS_b2Vec2_To_CCPoint(__b2Vec__) ccp(HS_B2V_VALUE(__b2Vec__.x),HS_B2V_VALUE(__b2Vec__.y))
#define HS_CCPoint_To_b2Vec2(__CCPoint__) HS_RATIO_b2Vec2(__CCPoint__.x,__CCPoint__.y)
