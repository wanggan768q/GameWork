...
{
	CCSprite* sick1 = CCSprite::create("Image/effect/SickMucus/sick1.png");
	CCSprite* sick2 = CCSprite::create("Image/effect/SickMucus/sick2.png");
	CCSprite* sick3 = CCSprite::create("Image/effect/SickMucus/sick3.png");
	CCSprite* sick4 = CCSprite::create("Image/effect/SickMucus/sick4.png");
	CCSprite* sick5 = CCSprite::create("Image/effect/SickMucus/sick2.png");
	CCSprite* sick6 = CCSprite::create("Image/effect/SickMucus/sick3.png");
	m_psick7 = CCSprite::create("Image/effect/SickMucus/sick4.png");
