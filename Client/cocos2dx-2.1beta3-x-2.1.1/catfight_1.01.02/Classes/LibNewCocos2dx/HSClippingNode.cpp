...
HSClippingNode* HSClippingNode::create()
{
	HSClippingNode *pRet = new HSClippingNode();
	if (pRet && pRet->init())
	{
		pRet->autorelease();
	}
...
HSClippingNode* HSClippingNode::create(CCNode *pStencil)
{
	HSClippingNode *pRet = new HSClippingNode();
...
bool HSClippingNode::init()
{
	return init(NULL);
}

bool HSClippingNode::init(CCNode *pStencil)
{
	CC_SAFE_RELEASE(m_pStencil);
	m_pStencil = pStencil;
...
void HSClippingNode::onEnter()
{
	CCNode::onEnter();
	m_pStencil->onEnter();
}

void HSClippingNode::onEnterTransitionDidFinish()
{
	CCNode::onEnterTransitionDidFinish();
	m_pStencil->onEnterTransitionDidFinish();
}

void HSClippingNode::onExitTransitionDidStart()
{
	m_pStencil->onExitTransitionDidStart();
	CCNode::onExitTransitionDidStart();
}

void HSClippingNode::onExit()
{
	m_pStencil->onExit();
	CCNode::onExit();
}

void HSClippingNode::visit()
{
	...
	// this will allow nesting up to n HSClippingNode,
...
CCNode* HSClippingNode::getStencil() const
{
	return m_pStencil;
}

void HSClippingNode::setStencil(CCNode *pStencil)
{
	CC_SAFE_RELEASE(m_pStencil);
	m_pStencil = pStencil;
	CC_SAFE_RETAIN(m_pStencil);
...
GLfloat HSClippingNode::getAlphaThreshold() const
{
	return m_fAlphaThreshold;
}

void HSClippingNode::setAlphaThreshold(GLfloat fAlphaThreshold)
{
	m_fAlphaThreshold = fAlphaThreshold;
}

bool HSClippingNode::isInverted() const
{
	return m_bInverted;
}

void HSClippingNode::setInverted(bool bInverted)
{
