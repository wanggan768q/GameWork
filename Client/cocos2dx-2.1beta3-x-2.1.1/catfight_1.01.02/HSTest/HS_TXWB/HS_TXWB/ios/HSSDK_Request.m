...
+(HSSDK_Request*) SharedSDKRequest
{
    if (!s_HSSDK_Request)
    {
        ...
        s_HSSDK_Request.m_appid = @"123";
        s_HSSDK_Request.m_gameUUID = @"22ad654sd";
        s_HSSDK_Request.m_type = @"99";
    }
...
{
    NSString *urlString = [[NSString alloc] initWithFormat:@"%@%@",HS_SDK_NET_ADDRESS,@"operationStatistics/apiUser.php"];
    ...
    NSDictionary* pData = [NSDictionary dictionaryWithObjectsAndKeys:
                           ...
                           [NSNumber numberWithInt:[m_appid intValue]],@"appID",               //产品唯一ID
