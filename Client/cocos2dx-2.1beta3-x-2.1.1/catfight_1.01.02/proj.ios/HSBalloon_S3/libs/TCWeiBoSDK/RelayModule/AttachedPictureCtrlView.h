...
@interface AttachedPictureCtrlView : UIView {
	...
	id<AttachedPictureCtrlViewDelegate>		myAttachedPictureCtrlViewDelegate;
}
@property (nonatomic, assign) UIImageView		*baseView;
@property (nonatomic, assign) id<AttachedPictureCtrlViewDelegate>	myAttachedPictureCtrlViewDelegate;
